...
I1 = imread('imagee1.jpg');
I2 = imread('imagee2.jpg');
figure
...
%% "extractFeatures" as Feature Extractor
...
%     figure
%     image(img);
%     imwrite (img, ['imagee' num2str(i) '.jpg']);
% end
% clear cam
...
I1_g = im2gray(I1);
I2_g = im2gray(I2);
points1 = detectHarrisFeatures(I1_g);
points2 = detectHarrisFeatures(I2_g);

[features1,valid_points1] = extractFeatures(I1_g,points1);
[features2,valid_points2] = extractFeatures(I2_g,points2);
